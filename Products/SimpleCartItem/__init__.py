...
#from Products.SimpleCartItem import config
...
#SimpleCartItemMessageFactory = MessageFactory('Products.SimpleCartItem')
...
#setDefaultRoles("SimpleCartItem: Add SimpleCartItem", ('Manager', 'Owner', 'Contributor',))

#CartMessageFactory = MessageFactory('Products.SimpleCartItem')

ADD_PERMISSIONS = {
    "SimpleCartItem": "SimpleCartItem: Add SimpleCartItem",
    }
...
SimpleCartItemMessageFactory = MessageFactory(PROJECTNAME)
